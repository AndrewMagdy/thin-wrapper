(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('poc-react-components', ['exports', '@angular-react/core', '@angular/common', '@angular/core', 'poc-react-app'], factory) :
    (factory((global['poc-react-components'] = {}),global['ɵa'],global.ng.common,global.ng.core,global.App));
    ...
    ***************************************************************************** */
    ...
    var PocReactAppComponent = /** @class */ (function (_super) {
        ...
        function PocReactAppComponent(elementRef, changeDetectorRef, renderer, ngZone) {
            ...
            _this.angularNavigateTo = new core$1.EventEmitter();
        ...
        PocReactAppComponent.propDecorators = {
            ...
            angularNavigateTo: [{ type: core$1.Output }]
        };
...
//# sourceMappingURL=poc-react-components.umd.js.map